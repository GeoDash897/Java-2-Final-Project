...
public class ImageTest extends JFrame implements KeyListener, ActionListener {
//opens program
...
public static File sonicImport;
public static File otherImport;
...
public static int xGoalPostBox = 300;
public static int yGoalPostBox = 400;
...
/***********************************************************/
    public ImageTest() {//constructor for JPanel
        add(new JP());
        //setting the right variables to their right Rectangles
...
/***********************************************************/
    public static void main(String[] args) {//start main method
        ...
        w.setVisible(true);
        w.addKeyListener(w);
        //Sets the picture for each of these sprites
        ...
        ShotMonitor = Toolkit.getDefaultToolkit().getImage("src\\resources\\Neo Ring Box.png");
...
//***********************************************************
    public class JP extends JPanel {//start JPanel CLass
        ...
        public void paint(Graphics g) {//opens paint method
            ...
            //checks to see if the players lives is greater than 0 and the title value is the right value
            else if (title == 1 && lives > 0) {
                ...
                //creates player's collision box
                ...
                //drawEnvironment(g);   
                if(change == 5) {
                    //g.fillRect(xGoalPostBox,yGoalPostBox,192,144);                    
                } 
                if(Rings.size() > 0) {
                ...
                if(notwait==1 && left == false && right == true && duck == false && jump == 0 && spike == 0 && spring == 0) {
                    sonicImport = new File("src\\resources\\Neo Sonic Stand 1.png");
                    fileGetSonic(sonicImport);
                }
                else if(notwait==1 && left == true && right == false && duck == false && jump == 0 && spike == 0 && spring == 0) {
                    sonicImport = new File("src\\resources\\LNeo Sonic Stand 1.png");
                    fileGetSonic(sonicImport);
                }
                ...
                //I programmed it so that the player's yvalue decreases, when the gravity is positive, it causes gravity to start acting again               
                    ...
                    //This checks to see if Sonic is in a pit
                ...
                //All of this code determines the Oof value depending on what box the Player is colliding with           
               ...
               //All of this code (from Box1 to Box5) allows for Sonic to fall on rectangles 
                ...
                //this controls when Sonic hits a spike (go to the GlobalSpikeBox area to adjust each of the values for each individual spike)
                ...
                //This controls when the player jumps on a spring
                ...
                //Heavy Machine Gun, Shotgun and the X Key
...
public void StartUp(Graphics g) {
    ...
    if(Tanicombo < 20 || (Tanicombo >= 40 && Tanicombo < 60) || (Tanicombo >= 80 && Tanicombo < 100) || (Tanicombo >= 140)){
    ...
    if(starttimer < 500) {
        ...
        if(Taniledge >= 0 && Taniledge < 20) {
            sonicImport = new File("src\\resources\\Neo Sonic TLedge 1.png");
            fileGetSonic(sonicImport);  
            g.drawImage(TSonic, xTSonic, yTSonic, 140, 160, this);
            yTSonic = 305;   
        }
        else if(Taniledge >= 20 && Taniledge < 40) {
            sonicImport = new File("src\\resources\\Neo Sonic TLedge 2.png");
            fileGetSonic(sonicImport);   
            g.drawImage(TSonic, xTSonic-2, yTSonic, 140, 160, this);
            yTSonic = 305;   
        }
        else if(Taniledge >= 40 && Taniledge < 60) {
            sonicImport = new File("src\\resources\\Neo Sonic TLedge 3.png");
            fileGetSonic(sonicImport);  
            g.drawImage(TSonic, xTSonic-2, yTSonic, 140, 160, this);
            yTSonic = 305;   
        }
        ...
        if(Taniwait >= 0 && Taniwait < 20) {
            sonicImport = new File("src\\resources\\Neo Sonic TStand 4.png");
            fileGetSonic(sonicImport);   
            g.drawImage(TSonic, xTSonic, yTSonic, 110, 160, this); 
        }
        else if(Taniwait >= 20 && Taniwait < 40) {
            sonicImport = new File("src\\resources\\Neo Sonic TStand 5.png");
            fileGetSonic(sonicImport);     
            g.drawImage(TSonic, xTSonic, yTSonic, 110, 160, this); 
        }
    }
    else if(starttimer >= 1500 && starttimer < 1550) {
        sonicImport = new File("src\\resources\\Neo Sonic TWag 1.png");
        fileGetSonic(sonicImport);     
        g.drawImage(TSonic, xTSonic, yTSonic, 110, 160, this); 
    }
    else if(starttimer >= 1550 && starttimer < 1600) {
            sonicImport = new File("src\\resources\\LNeo Sonic TStand 1.png");
            fileGetSonic(sonicImport);    
        g.drawImage(TSonic, xTSonic, yTSonic, 110, 160, this); 
    }
        ...
        if(Tanicombo >= 0 && Tanicombo < 20) {
            sonicImport = new File("src\\resources\\LNeo Sonic TCombo 1.png");
            fileGetSonic(sonicImport);  
            g.drawImage(TSonic, xTSonic, yTSonic, 140, 160, this); 
        }
        else if(Tanicombo >= 20 && Tanicombo < 40) {
            sonicImport = new File("src\\resources\\LNeo Sonic Combo 2.png");
            fileGetSonic(sonicImport);      
            g.drawImage(TSonic, xTSonic, yTSonic, 140, 160, this);  
        }
        else if(Tanicombo >= 40 && Tanicombo < 60) {
            sonicImport = new File("src\\resources\\LNeo Sonic TCombo 3.png");
            fileGetSonic(sonicImport);  
            g.drawImage(TSonic, xTSonic, yTSonic, 140, 160, this);  
        }
        else if(Tanicombo >= 60 && Tanicombo < 80) {
            sonicImport = new File("src\\resources\\LNeo Sonic Combo 4.png");
            fileGetSonic(sonicImport);    
            g.drawImage(TSonic, xTSonic, yTSonic, 140, 160, this); 
        }
        else if(Tanicombo >= 80 && Tanicombo < 100) {
            sonicImport = new File("src\\resources\\LNeo Sonic TCombo 5.png");
            fileGetSonic(sonicImport);   
            yTSonic = 310;
            g.drawImage(TSonic, xTSonic, yTSonic, 110, 160, this); 
        }
        else if(Tanicombo >= 100 && Tanicombo < 120) {
            sonicImport = new File("src\\resources\\LNeo Sonic Combo 6.png");
            fileGetSonic(sonicImport);
            yTSonic = 310;
            g.drawImage(TSonic, xTSonic, yTSonic, 110, 160, this);  
        }
        else if(Tanicombo >= 120 && Tanicombo < 140) {
            sonicImport = new File("src\\resources\\LNeo Sonic TCombo 7.png");
            fileGetSonic(sonicImport);
            yTSonic = 305;
            g.drawImage(TSonic, xTSonic, yTSonic, 110, 160, this);
        }
        else if(Tanicombo >= 140 && Tanicombo < 160) {
            sonicImport = new File("src\\resources\\LNeo Sonic Combo 8.png");
            fileGetSonic(sonicImport);  
            g.drawImage(TSonic, xTSonic, yTSonic, 110, 160, this);  
        }      
    }
    ...
    if(starttimer >= 2400) {
        ...
        if(Tanilean >= 0 && Tanilean < 20) {
            sonicImport = new File("src\\resources\\Neo Sonic Lean 1.png");
            fileGetSonic(sonicImport);    
            g.drawImage(TSonic, xTSonic-45, yTSonic, 110, 160, this);      
        }
        else if(Tanilean >= 20 && Tanilean < 40) {
            sonicImport = new File("src\\resources\\Neo Sonic Lean 2.png");
            fileGetSonic(sonicImport);   
            g.drawImage(TSonic, xTSonic-45, yTSonic, 110, 160, this);      
        }    
    }
...
public void Debug(Graphics g, Font font1) {
    if(debug > 0) {
        g.setFont(font1);
...
public void Spring(Graphics g) {
    if(duck == false && jump == 0 && spike == 0 && left == false && right == true && spring == 1) {
        sonicImport = new File("src\\resources\\Neo Sonic Spring 1.png");
        fileGetSonic(sonicImport);
        g.drawImage(Sonic, xSonic, ySonic, 110, 160, this);
    }
    else if(duck == false && jump == 0 && spike == 0 && left == true && right == false && spring == 1) {
        sonicImport = new File("src\\resources\\LNeo Sonic Spring 1.png");
        fileGetSonic(sonicImport);
        g.drawImage(Sonic, xSonic, ySonic, 110, 160, this);
    }
}
...
public void Run(Graphics g) {
    ...
    if(duck == false && left == false && right == true && jump == 0 && leftpress == 0 && rightpress == 1  && anirun >= 0 && anirun <= 10 && spring == 0) {
        sonicImport = new File("src\\resources\\Neo Sonic Run 1.png");
        fileGetSonic(sonicImport);
...
public void Duck(Graphics g) {
    if(duck == true && left == false && right == true) {
        sonicImport = new File("src\\resources\\Neo Sonic Duck 1.png");
        fileGetSonic(sonicImport);
        g.drawImage(Sonic, xSonic+12, ySonic-15, 120, 100, this);
    }
    if(duck == true && left == true && right == false) {
        sonicImport = new File("src\\resources\\LNeo Sonic Duck 1.png");
        fileGetSonic(sonicImport);
...
public void Jump(Graphics g, int anijump) {
    if(duck == false && left == false && right == true && anijump%10 == 0) {
        sonicImport = new File("src\\resources\\Neo Sonic Jump 1.png");
        fileGetSonic(sonicImport);
        g.drawImage(Sonic, xSonic+12, ySonic+60, 120, 100, this);
    }
    else if(duck == false && left == false && right == true && anijump%10 == 1) {
        sonicImport = new File("src\\resources\\Neo Sonic Jump 2.png");
        fileGetSonic(sonicImport);
        g.drawImage(Sonic, xSonic+12, ySonic+60, 120, 100, this);
    }
    else if(duck == false && left == false && right == true && anijump%10 == 2) {
        sonicImport = new File("src\\resources\\Neo Sonic Jump 3.png");
        fileGetSonic(sonicImport);
        g.drawImage(Sonic, xSonic+12, ySonic+60, 120, 100, this);
    }
    else if(duck == false && left == false && right == true && anijump%10 == 3) {
        sonicImport = new File("src\\resources\\Neo Sonic Jump 4.png");
        fileGetSonic(sonicImport);
        g.drawImage(Sonic, xSonic+12, ySonic+60, 120, 100, this);
    }
    else if(duck == false && left == false && right == true && anijump%10 == 4) {
        sonicImport = new File("src\\resources\\Neo Sonic Jump 5.png");
        fileGetSonic(sonicImport);
        g.drawImage(Sonic, xSonic+12, ySonic+60, 120, 100, this);
    }
    ...
    if(duck == false && left == true && right == false && anijump%10 == 0) {
        sonicImport = new File("src\\resources\\LNeo Sonic Jump 1.png");
        fileGetSonic(sonicImport);
        g.drawImage(Sonic, xSonic+12, ySonic+60, 120, 100, this);
    }
    else if(duck == false && left == true && right == false && anijump%10 == 1) {
        sonicImport = new File("src\\resources\\LNeo Sonic Jump 2.png");
        fileGetSonic(sonicImport);
        g.drawImage(Sonic, xSonic+12, ySonic+60, 120, 100, this);
    }
    else if(duck == false && left == true && right == false && anijump%10 == 2) {
        sonicImport = new File("src\\resources\\LNeo Sonic Jump 3.png");
        fileGetSonic(sonicImport);
        g.drawImage(Sonic, xSonic+12, ySonic+60, 120, 100, this);
    }
    else if(duck == false && left == true && right == false && anijump%10 == 3) {
        sonicImport = new File("src\\resources\\LNeo Sonic Jump 4.png");
        fileGetSonic(sonicImport);
        g.drawImage(Sonic, xSonic+12, ySonic+60, 120, 100, this);
    }
    else if(duck == false && left == true && right == false && anijump%10 == 4) {
        sonicImport = new File("src\\resources\\LNeo Sonic Jump 5.png");
        fileGetSonic(sonicImport);
        g.drawImage(Sonic, xSonic+12, ySonic+60, 120, 100, this);
    }
...
public void Blink(Graphics g, int aniblink) {
    if (right == true && left == false && duck == false){
        if (aniblink == 800){
        sonicImport = new File("src\\resources\\Neo Sonic Stand 2.png");
        fileGetSonic(sonicImport);
        }
        else if (aniblink == 850){
        sonicImport = new File("src\\resources\\Neo Sonic Stand 3.png");
        fileGetSonic(sonicImport);
        }
        else if (aniblink%100 == 0 && aniblink  >= 900 && aniblink < 2000){
        sonicImport = new File("src\\resources\\Neo Sonic Stand 4.png");
        fileGetSonic(sonicImport);
        }
        else if (aniblink%100 == 50 && aniblink  >= 900 && aniblink < 2000){
        sonicImport = new File("src\\resources\\Neo Sonic Stand 5.png");
        fileGetSonic(sonicImport);
        }   
        else if (aniblink >= 2000 && aniblink < 2100){
        sonicImport = new File("src\\resources\\Neo Sonic Wrist 1.png");
        fileGetSonic(sonicImport);
         }
    }
    if (right == false && left == true && duck == false){
        if (aniblink == 800){
        sonicImport = new File("src\\resources\\LNeo Sonic Stand 2.png");
        fileGetSonic(sonicImport);
        }
        else if (aniblink == 850){
        sonicImport = new File("src\\resources\\LNeo Sonic Stand 3.png");
        fileGetSonic(sonicImport);
        }
        else if (aniblink%100 == 0 && aniblink  >= 900 && aniblink < 2000){
        sonicImport = new File("src\\resources\\LNeo Sonic Stand 4.png");
        fileGetSonic(sonicImport);
        }
        else if (aniblink%100 == 50 && aniblink  >= 900 && aniblink < 2000){
        sonicImport = new File("src\\resources\\LNeo Sonic Stand 5.png");
        fileGetSonic(sonicImport);
        }   
        else if (aniblink >= 2000 && aniblink < 2100){
        sonicImport = new File("src\\resources\\LNeo Sonic Wrist 1.png");
        fileGetSonic(sonicImport);
        }    
    }     
}
...
public void keyPressed(KeyEvent e) {
    if (e.getKeyCode() == e.VK_RIGHT && actend == 0 && spike == 0 && title == 1) {
        rightpress=1;
        leftpress = 0;
    }
    if (e.getKeyCode() == e.VK_LEFT && actend == 0 && spike == 0 && title == 1) {    
        leftpress = 1;  
        rightpress = 0;
    }
    ...
    if (e.getKeyCode() == e.VK_DOWN && jump == 0 && actend == 0 && spike == 0 && title == 1 && spring == 0) {
        duck = true;
        BulletDelay = 0;
        xpress = 0;
        if(duckcheck == -2) {
    ...
    if (e.getKeyCode() == e.VK_Z && title == 1 && actend == 0 && duck == false) {
        collisioncheck = 1;
        if (collide) {
            ySonic -= 20;
            collide=false;
    ...
    if(e.getKeyCode() == e.VK_X && e.getKeyCode() != e.VK_DOWN && title == 1 && actend == 0 && duck == false && spike == 0 && spring == 0) {
        xpress = 1;        
    }
...
public void fileGetSonic(File getPicture) {
    try {
        if(title == -1) {
            TSonic = ImageIO.read(getPicture);
        }
        else if(title == 0 || (title == 1 && lives > 0)) {
            Sonic = ImageIO.read(getPicture);    
        }
        else if(title == 1 && lives == 0) {
            CSonic = ImageIO.read(getPicture);    
        }
...
public void drawHUD(Graphics g, Font HUDtext) {
    g.setColor(Color.white);
    g.setFont(HUDtext);
    ...
    g.drawString(""+score,220,47);  
        if(powerUp > 0) {
            if(powerUp == 1) {
                ...
                g.drawImage(ShotMonitor,600,10,48,92,this); 
            } 
...
public void ringDraw(Graphics g,int i, Rectangle ringRect){
    g.drawImage(ringPic,ringRect.x,ringRect.y,50,50,this);
    g.drawString(""+ringRect,500,50+50*i);
 }
public void ringGet(Graphics g, int i) {
...
public void HMG(Graphics g,int i){
...
public void ShotGun(Graphics g,int i){
    for(int f = 0;f < HMGMon.size();f++){
        collideHMGMon(g,HMGMon.get(f),Bullet.get(i));
        removeHMGMon(g,f,Bullet.get(i));
    }
...
public void drawRingMon(Graphics g, Rectangle RingMon, int i) {
    g.drawImage(ShotMonitor,RingMon.x,RingMon.y,wMon,hMon,this);
    g.drawString(""+HMGMon, 700, 200+100*i);
...
public void resultScreen(Graphics g, Font textHUD) {
    ...
    if(ringsCollected > 0 && !clip.isRunning() && "Act Clear SPA.wav".equals(music)) {
        pause(5);
        ringsCollected --;
        score+=100;
    }
    else if(ringsCollected == 0 && timeScore > 0) {
        pause(5);
        timeScore -=100;
        score+=100;
    }
    ...
    if(ringsCollected == 0 && timeScore == 0) {
        actFadeTimer ++;
        if(actFadeTimer >= 0 && actFadeTimer < 10) {
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 10 && actFadeTimer < 20) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 2.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 20 && actFadeTimer < 30) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 3.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 30 && actFadeTimer < 40) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 4.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 40 && actFadeTimer < 50) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 5.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 50 && actFadeTimer < 60) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 6.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 60 && actFadeTimer < 70) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 7.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 70 && actFadeTimer < 80) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 8.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 80 && actFadeTimer < 90) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 9.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 90 && actFadeTimer < 100) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 10.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 100 && actFadeTimer < 110) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 7.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 110 && actFadeTimer < 120) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 8.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 120 && actFadeTimer < 130) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 9.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 130 && actFadeTimer < 140) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 10.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 140 && actFadeTimer < 150) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 11.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 150 && actFadeTimer < 160) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 12.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 170 && actFadeTimer < 180) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 13.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 180 && actFadeTimer < 190) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 14.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 200 && actFadeTimer < 210) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 15.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 210 && actFadeTimer < 220) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 16.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 220 && actFadeTimer < 230) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 17.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 230 && actFadeTimer < 240) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 18.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 240 && actFadeTimer < 250) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 19.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 250 && actFadeTimer < 260) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 20.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
        else if(actFadeTimer >= 260) {
            BlackFade = Toolkit.getDefaultToolkit().getImage("src\\resources\\Black Fade 21.png");
            g.drawImage(BlackFade,0,0,1600,900,this); 
        }
    if(actFadeTimer > 500) {
        System.exit(0);
...
public void continueScreen(Graphics g, Font fontContinueTimer) {
    ...
    if(continueCutsceneTimer < 160) {
        ...
        if(Canispin >= 0 && Canispin < 5) {
            sonicImport = new File("src\\resources\\Neo Sonic Spin 1.png");
            fileGetSonic(sonicImport);
            g.drawImage(CSonic,xCSonic,yCSonic,wCSonic,hCSonic,this);
        }
        else if(Canispin >= 5 && Canispin < 10) {
            sonicImport = new File("src\\resources\\Neo Sonic Spin 2.png");
            fileGetSonic(sonicImport);
            g.drawImage(CSonic,xCSonic,yCSonic,wCSonic,hCSonic,this);
        }
        else if(Canispin >= 10 && Canispin < 15) {
            sonicImport = new File("src\\resources\\Neo Sonic Spin 3.png");
            fileGetSonic(sonicImport);
            g.drawImage(CSonic,xCSonic,yCSonic,wCSonic,hCSonic,this);
        }
        else if(Canispin >= 15 && Canispin < 20) {
            sonicImport = new File("src\\resources\\Neo Sonic Spin 4.png");
            fileGetSonic(sonicImport);
            g.drawImage(CSonic,xCSonic,yCSonic,wCSonic,hCSonic,this);
        }
        else if(Canispin >= 20 && Canispin < 25) {
            sonicImport = new File("src\\resources\\Neo Sonic Spin 5.png");
            fileGetSonic(sonicImport);
            g.drawImage(CSonic,xCSonic,yCSonic,wCSonic,hCSonic,this);
        }
        else if(Canispin >= 25 && Canispin < 30) {
            sonicImport = new File("src\\resources\\Neo Sonic Spin 6.png");
            fileGetSonic(sonicImport);
            g.drawImage(CSonic,xCSonic,yCSonic,wCSonic,hCSonic,this);
        }
        else if(Canispin >= 30 && Canispin < 35) {
            sonicImport = new File("src\\resources\\Neo Sonic Spin 7.png");
            fileGetSonic(sonicImport);
            g.drawImage(CSonic,xCSonic,yCSonic,wCSonic,hCSonic,this);
        }
        else if(Canispin >= 35 && Canispin < 40) {
            sonicImport = new File("src\\resources\\Neo Sonic Spin 8.png");
            fileGetSonic(sonicImport);
            g.drawImage(CSonic,xCSonic,yCSonic,wCSonic,hCSonic,this);
        }
    }
    else if(continueCutsceneTimer == 160) {
        sonicImport = new File("src\\resources\\Neo Sonic Dead.png");
        fileGetSonic(sonicImport);
    ...
    if(continueCutsceneTimer >= 250 && continueCutsceneTimer < 505) {
        ...
        sonicImport = new File("src\\resources\\Neo Sonic Get Up 1.png");
        fileGetSonic(sonicImport);
        g.drawImage(CSonic,xCSonic,yCSonic,130,110,this);
    }
    else if(continueCutsceneTimer >= 515 && continueCutsceneTimer < 520) {
        sonicImport = new File("src\\resources\\Neo Sonic Get Up 2.png");
        fileGetSonic(sonicImport); 
        g.drawImage(CSonic,xCSonic,yCSonic,130,110,this);
    }
        ...
        sonicImport = new File("src\\resources\\Angry Neo Sonic Stand 1.png");
        fileGetSonic(sonicImport); 
        g.drawImage(CSonic,xCSonic,yCSonic,110,160,this); 
    }
